//
//  PTLiveHardwareAudioEncoder.m
//  GPUImageDemo
//
//  Created by Fei Yuan on 2021/4/28.
//

#import "PTLiveHardwareAudioEncoder.h"

@interface PTLiveHardwareAudioEncoder (){
...
@property (nonatomic, strong) PTLiveAudioConfiguaration *configuration;
@property (nonatomic, weak) id<PTLiveAudioEncodingDelegate> aacDeleage;
@end

@implementation PTLiveHardwareAudioEncoder

- (instancetype)initWithAudioStreamConfiguration:(nullable PTLiveAudioConfiguaration *)configuration {
    if (self = [super init]) {
...
- (void)encodeBuffer:(char*)buf timeStamp:(uint64_t)timeStamp{
    ...
    PTLiveAudioFrame *audioFrame = [PTLiveAudioFrame new];
