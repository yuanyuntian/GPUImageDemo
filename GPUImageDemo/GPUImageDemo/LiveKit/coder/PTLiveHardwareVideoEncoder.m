//
//  PTLiveHardwareVideoEncoder.m
//  GPUImageDemo
//
//  Created by Fei Yuan on 2021/4/28.
//

#import "PTLiveHardwareVideoEncoder.h"
#import <VideoToolbox/VideoToolbox.h>

@interface PTLiveHardwareVideoEncoder (){
...
@property (nonatomic, strong) PTLiveVideoConfiguration *configuration;
@property (nonatomic, weak) id<PTLiveVideoEncodingDelegate> h264Delegate;
...
@implementation PTLiveHardwareVideoEncoder

#pragma mark -- LifeCycle
- (instancetype)initWithVideoStreamConfiguration:(PTLiveVideoConfiguration *)configuration {
    if (self = [super init]) {
...
- (void)setDelegate:(id<PTLiveVideoEncodingDelegate>)delegate {
...
static void VideoCompressonOutputCallback(void *VTref, void *VTFrameRef, OSStatus status, VTEncodeInfoFlags infoFlags, CMSampleBufferRef sampleBuffer){
    ...
    PTLiveHardwareVideoEncoder *videoEncoder = (__bridge PTLiveHardwareVideoEncoder *)VTref;
    if (status != noErr) {
        return;
    }
    ...
    if (statusCodeRet == noErr) {
        ...
        while (bufferOffset < totalLength - AVCCHeaderLength) {
            ...
            PTLiveVideoFrame *videoFrame = [PTLiveVideoFrame new];
