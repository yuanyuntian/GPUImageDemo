...
typedef NS_ENUM (NSUInteger, PTLiveVideoSessionPreset){
    /// 低分辨率
    PTCaptureSessionPreset360x640 = 0,
    /// 中分辨率
    PTCaptureSessionPreset540x960 = 1,
    /// 高分辨率
    PTCaptureSessionPreset720x1280 = 2
};

/// 视频质量
typedef NS_ENUM (NSUInteger, PTLiveVideoQuality){
    /// 分辨率： 360 *640 帧数：15 码率：500Kps
    PTVideoQuality_Low1 = 0,
    /// 分辨率： 360 *640 帧数：24 码率：800Kps
    PTVideoQuality_Low2 = 1,
    /// 分辨率： 360 *640 帧数：30 码率：800Kps
    PTVideoQuality_Low3 = 2,
    /// 分辨率： 540 *960 帧数：15 码率：800Kps
    PTVideoQuality_Medium1 = 3,
    /// 分辨率： 540 *960 帧数：24 码率：800Kps
    PTVideoQuality_Medium2 = 4,
    /// 分辨率： 540 *960 帧数：30 码率：800Kps
    PTVideoQuality_Medium3 = 5,
    /// 分辨率： 720 *1280 帧数：15 码率：1000Kps
    PTVideoQuality_High1 = 6,
    /// 分辨率： 720 *1280 帧数：24 码率：1200Kps
    PTVideoQuality_High2 = 7,
    /// 分辨率： 720 *1280 帧数：30 码率：1200Kps
    PTVideoQuality_High3 = 8,
    /// 默认配置
    PTVideoQuality_Default = PTVideoQuality_Low2
};


NS_ASSUME_NONNULL_BEGIN

@interface PTLiveVideoConfiguration : NSObject
...
///< 分辨率
@property (nonatomic, assign) PTLiveVideoSessionPreset sessionPreset;
