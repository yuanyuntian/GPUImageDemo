...
@class PTLiveVideoCapture;
/** LFVideoCapture callback videoData */
@protocol PTVideoCaptureDelegate <NSObject>
...
@interface PTLiveVideoCapture : NSObject
...
@property (nullable, nonatomic, weak) id<PTVideoCaptureDelegate> delegate;
...
/**
   ...
   capture unstable.
 */
- (nullable instancetype)initWithVideoConfiguration:(nullable PTLiveVideoConfiguration *)configuration NS_DESIGNATED_INITIALIZER;
