...
@implementation PTLiveVideoCapture
...
- (instancetype)initWithVideoConfiguration:(PTLiveVideoConfiguration *)configuration {
    if (self = [super init]) {
