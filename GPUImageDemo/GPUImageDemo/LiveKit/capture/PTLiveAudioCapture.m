...
NSString *const PTAudioComponentFailedToCreateNotification = @"PTAudioComponentFailedToCreateNotification";

@interface PTLiveAudioCapture()

@property (nonatomic, assign) AudioComponentInstance componetInstance;
@property (nonatomic, assign) AudioComponent component;
@property (nonatomic, strong) dispatch_queue_t taskQueue;
@property (nonatomic, assign) BOOL isRunning;
@property (nonatomic, strong,nullable) PTLiveAudioConfiguaration *configuration;

@end

@implementation PTLiveAudioCapture

#pragma mark -- LiftCycle
- (instancetype)initWithAudioConfiguration:(PTLiveAudioConfiguaration *)configuration{
    if(self = [super init]){
        _configuration = configuration;
        self.isRunning = NO;
        self.taskQueue = dispatch_queue_create("com.GPUImageDemo.audioCapture.Queue", NULL);
...
- (void)handleAudioComponentCreationFailure {
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:PTAudioComponentFailedToCreateNotification object:nil];
    });
}
...
static OSStatus handleInputBuffer(void *inRefCon,
    ...
    @autoreleasepool {
        PTLiveAudioCapture *source = (__bridge PTLiveAudioCapture *)inRefCon;
        if (!source) return -1;
