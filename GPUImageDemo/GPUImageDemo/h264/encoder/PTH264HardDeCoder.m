...
@implementation PTH264HardDeCoder
...
-(BOOL)configDecoder {
    ...
    if(status == noErr) {
        ...
        callBackRecord.decompressionOutputCallback = finishDecompress;
...
//解码回调
static void finishDecompress( void *decompressionOutputRefCon, void *sourceFrameRefCon, OSStatus status, VTDecodeInfoFlags infoFlags, CVImageBufferRef pixelBuffer, CMTime presentationTimeStamp, CMTime presentationDuration ){
    CVPixelBufferRef *outputPixelBuffer = (CVPixelBufferRef *)sourceFrameRefCon;
    
    //持有pixelBuffer数据，否则会被释放
    *outputPixelBuffer = CVPixelBufferRetain(pixelBuffer);
    PTH264HardDeCoder *decoder = (__bridge PTH264HardDeCoder *)decompressionOutputRefCon;
    if (decoder.delegate)
    {
