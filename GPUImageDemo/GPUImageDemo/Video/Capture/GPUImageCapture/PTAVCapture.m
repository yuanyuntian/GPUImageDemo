...
__weak static PTAVCapture *sAWAVCapture = nil;
...
//是否已发送了sps/pps
@property (nonatomic, assign) BOOL isSpsPpsAndAudioSpecificConfigSent;

//编码管理
@property (nonatomic, strong) PTEncoderManager *encoderManager;
...
-(PTEncoderManager *)encoderManager{
    if (!_encoderManager) {
        _encoderManager = [[PTEncoderManager alloc] init];
        //设置编码器类型
